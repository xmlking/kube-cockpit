...
import { AuthModule, AuthState } from '@kube-cockpit/auth';
import { NavigatorModule, MenuState } from '@kube-cockpit/navigator';
import { NgxsSocketioPluginModule } from '@kube-cockpit/socketio-plugin';
